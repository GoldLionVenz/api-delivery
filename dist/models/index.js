...
exports.productModel = exports.orderModel = exports.shoppingCartModel = exports.userModel = exports.paymentModel = void 0;
...
var _paymentModel = _interopRequireDefault(require("./payment-model"));
...
const paymentModel = (0, _paymentModel.default)({
  Schema: _mongoose.default.Schema,
  Model: _mongoose.default.model,
  plugins: _mongoosePaginateV.default
});
